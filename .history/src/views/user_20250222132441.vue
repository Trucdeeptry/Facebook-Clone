    ...
    <div class="w-full min-h-[100vh] pb-20 bg-[#F1F2F5] dark:bg-dark-main">
      ...
      >
        <div id="LeftSection" class="md:sticky h-fit -top-[100%] w-full md:w-5/12 mr-4">
          <user_card title="Intro">
            <div class="text-sm">
              <div class="pb-5">
                ...
                <div v-else>
                  <p class="text-center font-normal py-3">{{ userProfile.bio }}</p>
                  <button
                    class="w-full bg-gray-200 dark:bg-dark-third dark:hover:bg-dark-hover cursor-pointer hover:bg-gray-300 rounded-lg p-2 font-bold"
                  >
                    Edit bio
          ...
          <user_card title="Friends">
            <div>
              ...
              <div class="grid grid-cols-3 cursor-pointer gap-3 py-2">
                <div
        ...
        <div id="PostsSection" class="w-ful md:w-7/12 overflow-auto">
          <post_form></post_form>
          <post
            v-if="userProfile.userPosts"
            :postsProp="userProfile.userPosts"
          ></post>
        </div>
      </div>
    </div>
...
onBeforeMount(async () => {
  try {
    ...
    console.log(userPostImg.value);
    
    userPostImg.value = userProfile.value.userPosts.map((post) => post.image);
