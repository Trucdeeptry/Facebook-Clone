  ...
  <form @submit.prevent="findUser(email)">
    <card title="Find Your Account">
      <template #body>
        ...
        <p v-if="isError" class="">Your email is wrong. Please check again!</p>
      </template>

      <template #footer>
        <div class="flex justify-end gap-3 items-center">
          <baseButton tailwind="bg-gray-200 text-black" push="/login"
            >Cancel</baseButton
          >
          <baseButton type="submit" tailwind="bg-blue-500 text-white">
            <div>
