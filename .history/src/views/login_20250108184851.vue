  ...
  <div>
        ...
        >
          <div class="big-box">
            <div class="left-box">
              ...
              >
                <div
                  class="account_logged add_account"
    ...
    <Transition name="fade">
      <div
        ...
        class="bg-[rgb(0,0,0,0.4)] fixed w-full h-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
      >
      <loginForm class="!mx-auto !mt-28" :EmailInputText="userSelected.email">
        <template #avatar @click.stop>
          <img :src="userSelected.avatar" class="object-cover w-48 h-48 rounded-full m-auto" alt="">
        </template>
      </loginForm>
    </div>
    </Transition>
...
let recentUsers = ref([]);
onMounted(async () => {
  recentUsers.value = await usersInfo(emailUsers);
