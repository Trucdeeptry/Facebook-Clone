    ...
    <div class="bg-[#f0f2f5] pb-16">
      ...
      >
        ...
        <div class="p-4">
          ...
          <button
            type="submit"
            class="rounded text-white py-2 bg-[#00a400] block px-16 py-1 text-lg font-bold m-auto my-6 hover:bg-[rgb(0,160,0)]"
          >
            <!-- <span>Sign up</span> -->
...
const onSubmit = handleSubmit((values) => {
  ...
  const isSignupSuccesss = store.dispatch("auth/signUpAction", signUpInfo);
  if (isSignupSuccesss) {
