        ...
        >
          <div class="big-box">
            <div class="left-box">
              ...
              >
                <div
                  class="account_logged add_account relative group-hover:text-2xl"
                ...
                >
                  <i
                    class="absolute group origin-bottom-right fa-solid fa-circle-xmark text-lg left-1 hover:text-2xl transition-all  cursor-pointer"
                  ></i>
                  <img
                    :src="user.avatar"
                    alt="user avt"
