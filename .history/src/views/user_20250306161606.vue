                ...
                <div v-else>
                  <div v-if="isEditBio">
                    <textarea
                      v-model="editValue"
                      maxlength="100"
                      class="border py-2 text-center rounded-xl hover:opacity-70 bg-[#f0f2f5] dark:bg-[#333334] w-full mt-4"
                      id=""
                      cols="40"
                      rows="4"
                    >
                    </textarea>
                    <p class="text-end font-normal text-xs opacity-85">{{ 100 - editValue.length}} characters remaining</p>
                    <div class="flex justify-between items-center">
                      ...
                      <div>
                        <button class="p-4 bg-gray-200 ark:bg-dark-third dark:hover:bg-dark-hover cursor-pointer hover:bg-gray-300 rounded-lg">Cancel</button>
                        <button class="p-4 bg-gray-200 ark:bg-dark-third dark:hover:bg-dark-hover cursor-pointer hover:bg-gray-300 rounded-lg">Save</button>
                      </div>
                    </div>
                  </div>
