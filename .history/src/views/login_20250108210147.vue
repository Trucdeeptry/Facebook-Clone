          ...
          <div class="big-box">
            <div class="left-box">
              ...
              >
                ...
                >
                  <i
                    class="absolute group-hover:text-2xl group-hover:color-[#74C0FC] origin-bottom-right fa-solid fa-circle-xmark text-lg left-1 transition-all  cursor-pointer"
                  ></i>
                  <img
                    :src="user.avatar"
                    alt="user avt"
