                ...
                <div v-else>
                  <div v-if="isEditBio">
                    ...
                    <div class="flex justify-between items-center mt-2">
                      ...
                      <div class="flex items-center gap-2">
                        <button
                          class="p-2 bg-gray-200 dark:bg-dark-third dark:hover:bg-dark-hover cursor-pointer hover:bg-gray-300 rounded-lg"
                        >
                          Cancel
                        </button>
                        <button
                          :disabled="editValue == userProfile.bio"
                          class="p-2 disabled: disabled:opacity-50 disabled:bg-gray-300 disabled:cursor-not-allowed bg-gray-200 dark:bg-dark-third dark:hover:bg-dark-hover cursor-pointer hover:bg-gray-300 rounded-lg"
                        >
                          Save
                        </button>
                      </div>
