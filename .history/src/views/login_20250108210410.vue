          ...
          <div class="big-box">
            <div class="left-box">
              ...
              >
                ...
                >
                  <i
                  <i class="absolute group-hover:text-2xl group-hover:text-white origin-bottom-right fa-solid fa-circle-xmark text-lg left-1 transition-all cursor-pointer"></i>
                  ></i>
                  <img
                    :src="user.avatar"
                    alt="user avt"
