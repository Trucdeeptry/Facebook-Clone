<template>
  <div>
    ...
    <Transition>
      <div class="bg-[rgb(0,0,0, 0.5)] w-full h-full relative">
        <loginForm class="fixed top-[40%] left-1/2 -translate-y-1/2 -translate-x-1/2 !m-0" :isShowRemember="true">
         <div class="text-center border-b-2 p-4 my-2">
          <h1 class="text-xl">Log in to Facebook</h1>
         </div>
        </loginForm>
