  ...
  <div>
    <card title="Change your password">
      <template #body>
        ...
        <div class="my-3 flex flex-col items-center justify-center gap-3 w-full">
          <passwordInput v-model="pass"></passwordInput>
          <passwordInput v-model="retypePasss"></passwordInput>
        </div>
      </template>
