    ...
    >
      <template #body>
        <div class="flex justify-between">
          ...
          <div class="flex flex-col items-center justify-center mr-9">
            <img
              :src="user.avatar"
              alt="avt"
            ...
            <div class="text-center">
              <b>{{ user.info.firstName + " " + user.info.surName }}</b>
              <p class="text-sm text-gray-400">TSocial user</p>
              <a href="#" class="text-blue-500 hover:underline">Not you?</a>
            </div>
          </div>
        </div>
      </template>
      ...
      <template #footer>
        <div class="flex items-center justify-between">
          <a
            ...
            ></a
          >
          <b class="text-blue-500 hover:underline text-md"
