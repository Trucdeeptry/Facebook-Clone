<template>
  <div>
            ...
            <div class="left-box">
              ...
              >
                <div
                  ...
                  :key="user.email"
                  @click="isOpenForm = true; userSelected = user"
                >
                  <img
                    :src="user.avatar"
                    alt="user avt"
    ...
    <Transition name="fade">
      ...
      >
        <loginForm class="!mx-auto !mt-28" :EmailInputText="user.email" :isShowRemember="true" @click.stop>
          <template #default v-if="!isRecent">
