...
const { value: password, handleChange: passwordHandleChange, ...passwordProps } = defineField("pass");
const { value: confirmPass, handleChange: confirmPassHandleChange, ...confirmPassProps } = defineField("confirmPass");
