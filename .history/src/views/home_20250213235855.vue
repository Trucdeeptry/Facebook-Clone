<template>
  <header_nav :user="user"></header_nav>
  <div class="flex justify-center h-screen">
    <left_menu user="user"> </left_menu>
    <div class="w-full lg:w-2/3 xl:w-2/5 pt-32 lg:pt-16 px-2">
      <post_form user="user" class="!mt-20"></post_form>
      <story class="!mt-6"></story>
    </div>
...
onMounted(async () => {
  const user = await store.dispatch('auth/getInfo', info.email)  
})
