                ...
                <div v-else>
                  <div v-if="isEditBio">
                    ...
                    <div class="flex justify-between items-center">
                      ...
                      <div>
                        <button class="p-4 bg-gray-200">Cancel</button>
                        <button class="p-4 bg-gray-200">Save</button>
                      </div>
                    </div>
                  </div>

                  <div v-else>
                    <p class="text-center font-normal py-3 ark:bg-dark-third dark:hover:bg-dark-hover cursor-pointer hover:bg-gray-300 rounded-lg">
                      {{ userProfile.bio }}
                    </p>
                    <button
                      class="w-full bg-gray-200 dark:bg-dark-third dark:hover:bg-dark-hover cursor-pointer hover:bg-gray-300 rounded-lg p-2 font-bold"
