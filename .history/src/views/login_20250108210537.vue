          ...
          <div class="big-box">
            <div class="left-box">
              ...
              >
                ...
                >
                  <i
                    class="absolute group-hover:scale-150 fd group-hover:text-white origin-bottom-right fa-solid fa-circle-xmark text-lg left-1 transition-all cursor-pointer"
                  ></i>
