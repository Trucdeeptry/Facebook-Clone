                    ...
                    <div class="flex justify-between items-center mt-2">
                      ...
                      <div class="flex items-center gap-2">
                        ...
                        <button
                          ...
                          class="p-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:pointer-events-none bg-gray-200 dark:bg-dark-third dark:hover:bg-dark-hover cursor-pointer hover:bg-gray-300 rounded-lg"
                        >
                          Save
                        </button>
                      </div>
