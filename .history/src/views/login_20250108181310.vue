        ...
        >
          <div class="big-box">
            <div class="left-box">
              ...
              <div
                class="recent_login mt-7 flex items-center justify-start gap-3"
              >
                <div
                  class="account_logged add_account border w-[200px]"
                ...
                >
                  <img
                    :src="user.avatar"
                    alt="user avt"
                    class="object-cover w-[160px] h-[150px]"
                  />
                  <div
                    class="bg-white flex-grow flex items-center justify-center"
                  >
                    <p class="text-[#0866ff] text-lg p-3">{{ user.info.surName }}</p>
                  </div>
                </div>
                <div
                  class="add_account"
...
let recentUsers = [];
onMounted(async () => {
  recentUsers = await usersInfo(emailUsers);
