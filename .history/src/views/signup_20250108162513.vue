          ...
          >
              ...
              <div class="p-4">
                  ...
                  >
                      ...
                      >
                          ...
                          <input
                              ...
                              :id="option"
                              @focus="
                                  $refs['error-gender'].style.display = 'block';
                                  $refs['error-icon'].style.display = 'none';
                              "
                              @blur="
                                  $refs['error-gender'].style.display = 'none';
                                  $refs['error-icon'].style.display = 'block';
                              "
                          />
                      </label>
                      <div
                  ...
                  <div v-if="isCustom">
                      ...
                      <p class="text-xs opacity-60">Your pronoun is visible to everyone.</p>
                  ...
                  <div class="flex items-center justify-between gap-3 mb-3 mt-2">
                      <p class="text-xs text-[#777]">
                          ...
                          <a href="" class="text-[#385898] underline">Cookies Policy</a>. You may
...
function getFilteredYears() {
  ...
  return Array.from({ length: currentYear - 1900 + 1 }, (_, index) => 1900 + index).filter(
      (number) => number > 1900
  );
}
const date = new Date();
          ...
          .when("gender", {
              ...
              then: () =>
                  yup
                      ...
                      .test("not-zero", "Please select your pronoun", (value) => value !== 0)
...
const onSubmit = handleSubmit((values) => {
 ...
 const isSignupSuccesss = store.dispatch('signUpAction', values)
