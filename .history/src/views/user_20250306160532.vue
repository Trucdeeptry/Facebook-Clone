          ...
          <user_card title="Intro">
            <div class="text-sm">
              <div class="pb-5">
                ...
                <div v-else>
                  <textarea v-if="isEditBio" maxlength="100" class="border py-2 text-center rounded-xl hover:opacity-70 bg-[#333334] w-full my-4" id="" cols="40" rows="4">    {{ userProfile.bio }}</textarea>
                  <p v-else class="text-center font-normal py-3">
                    {{ userProfile.bio }}
                  </p>
                  <button
                    class="w-full bg-gray-200 dark:bg-dark-third dark:hover:bg-dark-hover cursor-pointer hover:bg-gray-300 rounded-lg p-2 font-bold"
