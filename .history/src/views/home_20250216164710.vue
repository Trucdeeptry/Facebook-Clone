<template>
  <loading-page v-if="!isInfoSuccess"></loading-page>
  <section v-else>
    <header_nav></header_nav>
    <div class="flex justify-center h-screen">
      <left_menu> </left_menu>
      <div class="w-full lg:w-2/3 xl:w-2/5 pt-32 lg:pt-16 px-2">
        <post_form @showCreatePost="showCreatePost" class="!mt-20"></post_form>
        <create_post :isModalOpen="isModalOpen" @closePost="closePost"></create_post>
...
import post_form from "../components/home/post_form.vue";
import story from "../components/home/story.vue";
import loadingPage from "./loadingPage.vue";
import loading_post from "../components/home/loading_post.vue";
import create_post from "../components/home/create_post.vue";
...
onMounted(async () => {
  // get info user
  user.value = await store.dispatch("auth/getInfo", info.email);
  isInfoSuccess.value = true;
});
</script>
