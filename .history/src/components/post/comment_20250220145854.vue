<template>
  ...
  <div class="py-2 px-4">
    <!-- COMMENT -->
    <div
      v-for="comment in props.commentsProp"
      :key="comment._id"
    ...
    >
      ...
      <div>
        <div class="inline-flex flex-col">
          ...
          <div
            class="p-2 relative text-xs text-gray-500 inline-flex gap-3 dark:text-dark-txt"
          >
            ...
            <span class="font-semibold cursor-pointer hover:underline"
              >Reply</span
            >
            <div v-if="comment.liked_by?.length > 0" class="absolute right-2 flex items-center gap-1">
        ...
        <div v-if="comment.replies.length > 0">
            <div v-for="replies in comment.replies" :key="replies.id" class="flex space-x-2"  >
              <img
...
console.log(props.commentsProp);
</script>
