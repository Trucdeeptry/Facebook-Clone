      ...
      <div class="px-4 py-2">
        <div class="flex items-center justify-between">
          <div
            ...
            v-if="(postEmotion = getPostEmotion(post.))"
          >
            <div
              v-for="emotion in getPostEmotion(post.liked_by).type"
              :key="emotion"
              class="-mr-0.5 text-gray-500 dark:text-dark-txt hover:underline cursor-pointer"
            >
              <i
            ...
            {{ getPostEmotion(post.liked_by).count }}
          </div>
