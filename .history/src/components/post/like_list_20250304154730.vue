...
function hanldeReactData(reactList) {
  ...
  return [
    { type: "like", count: reactCounts.like || 0, Id: reactUsers.like },
    { type: "heart", count: reactCounts.heart || 0, Id: reactUsers.heart },
    { type: "haha", count: reactCounts.haha || 0, Id: reactUsers.haha },
    { type: "wow", count: reactCounts.wow || 0, Id: reactUsers.wow },
    { type: "sad", count: reactCounts.sad || 0, Id: reactUsers.sad },
    { type: "angry", count: reactCounts.angry || 0, Id: reactUsers.angry },
  ];
}
</script>
