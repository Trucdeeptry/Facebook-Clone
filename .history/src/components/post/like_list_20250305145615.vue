    ...
    >
      ...
      <div class="flex justify-start gap-3 mt-3 flex-col">
        ...
        <div class="flex gap-3 justify-center flex-col">
          <div class="flex items-center gap-4" v-for="userInfo in user.userData" :key="userInfo._id">
            <img
              :src="userInfo.avatar"
              class="w-10 h-10 rounded-full object-cover"
              alt="User avatar"
            />
            <span class="font-bold dark:text-primary-txt hover:underline cursor-pointer">
