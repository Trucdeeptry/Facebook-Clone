  ...
  >
    <div class="w-1/3 p-3 h-[28rem] rounded-xl bg-white dark:bg-dark-second">
      <ul class="font-bold text-md dark:text-primary-txt flex">
        <li
          class="hover:bg-gray-100 dark:hover:bg-dark-third cursor-pointer p-3 rounded-xl"
        >
          All
        </li>
        <li
          class="flex justify-center items-center gap-1 hover:bg-gray-100 dark:hover:bg-dark-third cursor-pointer p-3 rounded-xl"
