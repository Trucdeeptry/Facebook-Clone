  ...
  >
    ...
    >
      ...
      <div class="flex justify-start gap-3 mt-3 flex-col">
        <div class="gap-3 flex-col flex" v-for="(user, index) in users[activeEmotion]" :key="index">
          <div
          ...
          >
            <div class="flex items-center gap-4 relative">
              ...
              />
              <span
                class="font-bold dark:text-primary-txt hover:underline cursor-pointer"
              >
                {{
            ...
            <button class="p-3 dark:text-primary-txt cursor-pointer bg-gray-400 rounded-2xl :hover:opacity-50"> 
