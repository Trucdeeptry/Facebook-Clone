...
function hanldeReactData(reactList) {
  ...
  return [
    { type: "like", count: reactCounts.like || 0, rea },
    { type: "heart", count: reactCounts.heart || 0, rea },
    { type: "haha", count: reactCounts.haha || 0, rea },
    { type: "wow", count: reactCounts.wow || 0, rea },
    { type: "sad", count: reactCounts.sad || 0, rea },
    { type: "angry", count: reactCounts.angry || 0, rea },
  ];
}
</script>
