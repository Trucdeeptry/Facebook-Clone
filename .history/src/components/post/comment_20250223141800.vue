<template>
  <!-- LIST COMMENT -->
  <section :class="`max-h-56`" class="relative">
    <div
  ...
  <div class="bg-black/25 w-full fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10">
    <user_card class="" :title="'Comments'"></user_card>
  </div>
  <!-- END LIST COMMENT -->
</template>
...
import user_card from "../user/user_card.vue";
