      ...
      <div>
        <div class="inline-flex flex-col">
          ...
          >
            ...
            <span class="max-w-96"><span v-if="authorOfReplies">{{  authorOfReplies.author_info.info.firstName +
              " " +
              authorOfReplies.author_info.info.surName }}</span>{{ comment.comment }}</span>
          </div>
          <div
