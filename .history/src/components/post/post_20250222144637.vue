<template>
  <section>
    ...
    >
      ...
      <!-- END POST ACTION -->
      <div
        class="py-2 z-10 relative before:content-[''] before:absolute before:bottom-0 before:left-0 before:right-0 before:h-8 before:bg-white before:bg-opacity-50 before:backdrop-blur-sm px-4 max-h-96 overflow-hidden"
      >
