<template>
  <div
    @click="hanlderClose"
    class="flex z-10 justify-center items-center fixed w-screen h-screen bg-black/75 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10"
  >
    <div
      @click.stop
      ...
      <div class="flex justify-start gap-3 mt-3 flex-col">
        ...
        >
          ...
          >
            ...
            <button
              class="p-2 text-sm px-3 font-semibold dark:text-black cursor-pointer bg-primary-txt rounded-xl hover:opacity-80"
            >
