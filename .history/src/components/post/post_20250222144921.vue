<template>
  <section>
    ...
    >
      ...
      <!-- END POST ACTION -->
      <div
        class="py-2 -mt-3 z-30 relative before:content-[''] before:absolute before:bottom-0 before:left-0 before:right-0 before:h-16 before:bg-white before:bg-opacity-100  px-4 max-h-96 overflow-hidden"
      >
