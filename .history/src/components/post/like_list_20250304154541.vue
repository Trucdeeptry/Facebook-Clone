...
function hanldeReactData(reactList) {
  ...
  return [
    { type: "like", count: reactCounts.like || 0, reactUsers },
    { type: "heart", count: reactCounts.heart || 0, reactUsers },
    { type: "haha", count: reactCounts.haha || 0, reactUsers },
    { type: "wow", count: reactCounts.wow || 0, reactUsers },
    { type: "sad", count: reactCounts.sad || 0, reactUsers },
    { type: "angry", count: reactCounts.angry || 0, reactUsers },
  ];
}
</script>
