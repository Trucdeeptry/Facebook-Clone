...
function hanldeReactData(reactList) {
  ...
  // ];
  return [
    {  count: reactCounts.like || 0, userId: reactUsers.like },
    {  count: reactCounts.heart || 0, userId: reactUsers.heart },
    {  count: reactCounts.haha || 0, userId: reactUsers.haha },
    {  count: reactCounts.wow || 0, userId: reactUsers.wow },
    {  count: reactCounts.sad || 0, userId: reactUsers.sad },
    {  count: reactCounts.angry || 0, userId: reactUsers.angry },
  ];
}
</script>
