<template>
  <div
    @click="hanlderClose"
    class="flex justify-center items-center fixed w-screen h-screen scroll-container overflow-y-scroll bg-black/75 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10"
  >
    <div
      @click.stop
    ...
    >
      ...
      <div class="flex justify-start gap-3 mt-3 flex-col">
        ...
        >
        <div>
          <div v-for="userInfo in user.userData" :key="userInfo._id">
            <img
              :src="userInfo.avatar"
            ...
            <span class="font-bold dark:text-primary-txt">
              {{ userInfo.info.firstName + " " + userInfo.info.surName }}</span
            >
          </div>
        </div>
          <div
