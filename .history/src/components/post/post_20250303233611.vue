    ...
    >
      ...
      <div class="px-4 py-2">
        <div class="flex items-center justify-between">
          ...
          >
            <div class="inline-block" v-for="react in getPostEmotion(post.liked_by)" :key="react">
              <div
                class="-mr-2 text-gray-500 dark:text-dark-txt hover:underline mr-2 cursor-pointer"
              >
                <i
                  :class="iconMap[react]"
                  :style="{ color: iconColorMap[react] }"
                ></i>
              </div>
            </div>
          </div>
