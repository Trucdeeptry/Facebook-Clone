...
function hanldeReactData(reactList) {
  ...
  return [
    { type: "like", count: reactCounts.like || 0, reactUsers.like || [] },
    { type: "heart", count: reactCounts.heart || 0, reactUsers.heart || [] }, },
    { type: "haha", count: reactCounts.haha || 0, reactUsers.haha || [] },
    { type: "wow", count: reactCounts.wow || 0, reactUsers.wow || [] },
    { type: "sad", count: reactCounts.sad || 0, reactUsers.sad || [] },
    { type: "angry", count: reactCounts.angry || 0, reactUsers.angry || [] }, },
  ];
}
</script>
