<template>
  <section>
    ...
    <h1
      v-else-if="props.postsProp.length == 0"
      class="text-center font-bold text-2xl mt-10"
    >
      Nothing Here!
    </h1>
    <div
    ...
    >
        ...
        <div class="flex space-x-2 items-center">
          ...
          <div>
            ...
            <div class="flex gap-1 items-center">
              <span  class="text-sm text-gray-500" v-if="post.">Sponsor</span>
      ...
      <div class="px-4 py-2">
       ...
       <div class="flex gap-1 flex-wrap mt-3">
        <p class="font-bold hover:underline cursor-pointer" v-for="hashtag in post.hashtags" :key="hashtag">{{ hashtag }}</p>
