<template>
  <section>
    ...
    >
      ...
      <div class="px-4 py-2">
        <div class="flex items-center justify-between">
          <div class="flex flex-row-reverse items-center">
            <span class="ml-2 text-gray-500 dark:text-dark-txt hover:underline mr-2 cursor-pointer">{{
          ...
          <div class="text-gray-500 dark:text-dark-txt flex items-center gap-3">
            <span
              >
              <span class="mr-2">{{ countComment(post.comments) }}</span>
      ...
      <!-- END POST ACTION -->
      <div
        class="p-2 max-h-56 overflow-hidden "
      >
