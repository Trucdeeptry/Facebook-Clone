<template>
  <div
    @click="hanlderClose"
    class="flex justify-center items-center fixed w-screen h-screen scroll-container over bg-black/75 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10"
  >
    <div
      @click.stop
