          ...
          <div class="p-4">
            ...
            >
              ...
              <div class="flex items-center">
                ...
                >
                  <i
                    class="fa-regular fa-face-laugh text-[23px]"
                    style="color: #ffd43b"
                  ></i>
                </button>
                <button
                ...
                >
                  <i
                    class="fa-solid fa-photo-film text-[23px]"
                    style="color: #63e6be"
                  ></i>
                </button>
                <button
                ...
                >
                  <i
                    class="fa-solid fa-user-tag text-[23px]"
                    style="color: #74c0fc"
                  ></i>
                </button>
                <button
                  class="hover:bg-gray-200 rounded-full p-2 cursor-pointer"
                >
                  <i class="fa-solid fa-ellipsis text-[23px]"></i>
                </button>
              </div>
            </div>
