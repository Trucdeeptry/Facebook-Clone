<template>
  ...
  >
    <div class="grid h-screen place-items-center p-4">
      <div
        class="dark:bg-dark-main bg-white-500 w-full max-w-[600px] mx-auto shadow-xl rounded-xl"
      >
        <div class="flex items-center relative my-3.5 mx-1">
          <div
            class="text-[22px] text-primary-txt dark:text-primary-txt font-bold w-full text-center"
          >
            Create post
          </div>
          <div
