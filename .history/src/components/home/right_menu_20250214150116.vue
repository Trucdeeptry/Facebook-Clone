<template>
  <loading_spinner v-if="!isFriendSuccess"></loading_spinner>
  <div v-else
...
onMounted(async () => {
  // get friends
  friends.value = await store.dispatch("home/getFriends", user.value.email);
