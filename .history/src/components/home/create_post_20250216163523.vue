    ...
    <div class="grid h-screen place-items-center p-4">
      <div class="bg-white w-full max-w-[600px] mx-auto shadow-xl rounded-xl">
        <div class="flex items-center relative my-3.5 mx-1">
          ...
          <div
            class="absolute right-3 rounded-full p-1.5 px-3 bg-gray-200 hover:bg-gray-300 cursor-pointer"
          >
        ...
        <div class="border-t border-t-gray-300">
          <div class="p-4">
            <div class="flex items-center">
              <img class="rounded-full ml-1 min-w-[45px] max-h-[45px]" src="/img/home/avt-2.jpg" />
              <div class="ml-4">
                <div class="font-extrabold">name</div>
                <div
                  class="flex items-center justify-between w-[100px] bg-gray-200 p-1 px-2 rounded-lg"
                >
            ...
            <div class="max-h-[350px] overflow-auto">
              <textarea
                class="w-full border-0 p-2 mt-4 focus:ring-0 text-[22px]"
            ...
            >
              ...
              <div class="flex items-center">
                ...
                <button
                  class="hover:bg-gray-200 rounded-full p-2 cursor-pointer w-12 h-12"
                >
                  <i
