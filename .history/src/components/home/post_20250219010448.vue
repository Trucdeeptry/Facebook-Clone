<template>
  <section>
    <div
      v-for="post in postsFormated.value"
      :key="post.value._id"
          ...
          <div>
            <div class="font-semibold">
              <a href="#" class="hover:!underline">{{
                post.value.author_info.info.firstName +
                " " +
                post.value.author_info.info.surName
              }}</a>
            </div>
            <div class="flex gap-1 items-center">
              <span class="text-sm text-gray-500">{{ post.value.formatedTime }}</span>
              <span>·</span>
...
import { computed, defineProps, inject, onBeforeMount, ref } from "vue";
