          ...
          <div class="p-4">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                ...
                <div
                  class="flex cursor-pointer items-center justify-between px-2 w-[100px] bg-gray-200 p-1 px-2 rounded-lg"
                >
            ...
            <div class="max-h-[350px] overflow-auto">
              <textarea
                class="w-full border-none border-0 p-2 mt-4 focus:ring-0 text-[22px]"
