<template>
  ...
  <section>
    <loading_post v-if="!props.postsProp && props."></loading_post>
    <div
      v-for="post in posts"
      :key="post._id"
    ...
    >
      ...
      <!-- POST IMAGE -->
      <div class="py-2">
        <img :src="post.image" class="w-full max-h-[600px] object-cover" alt="Post image" />
      </div>
      <!-- END POST IMAGE -->
      ...
      <div class="px-4 py-2">
        <div class="flex items-center justify-between">
          <div class="flex flex-row-reverse items-center">
            <span class="ml-2 text-gray-500 dark:text-dark-txt">{{ post.liked_by.length }}</span>
            <span
