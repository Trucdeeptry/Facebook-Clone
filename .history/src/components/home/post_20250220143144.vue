      ...
      <div class="px-4 py-2">
        <div class="flex items-center justify-between">
          ...
          <div class="text-gray-500 dark:text-dark-txt flex items-center gap-3">
            <span
              >{{ countComment(post.postComments) }}
      ...
      <div class="py-2 px-4">
        ...
        >
          ...
          <div>
            <div>
              <div
                class="bg-gray-100 dark:bg-dark-third flex-col p-2 rounded-2xl text-sm"
              >
                <a href="#" class="hover:underline font-semibold inline-block">{{
