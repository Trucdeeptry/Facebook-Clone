<template>
  <div
    class="bg-white dark:bg-dark-second h-max md:h-14 w-full border-[#e5e7eb] shadow flex flex-col md:flex-row items-center justify-center md:justify-between fixed top-0 z-50 border-b dark:border-dark-third"
  >
    <!-- LEFT NAV -->
    <div class="flex z items-center justify-between gap-2 px-4 py-2">
      ...
      <div class="flex items-center justify-between space-x-1">
        ...
        >
          <i
            class="bx -mb-1 bx-search-alt-2 text-xl xl:mr-2 dark:text-dark-txt"
          ></i>
          <input
            type="text"
    ...
    <ul class="flex w-full lg:w-max items-center justify-center !mt-1">
      <li
        class="w-1/5 md:w-max text-center border-primary-button-background border-b-4"
      >
        <a
          href="#"
        ...
        >
          <svg
            ...
            height="24"
            fill="currentColor"
            class="text-primary-button-background"
          >
            <path
