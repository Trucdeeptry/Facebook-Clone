<template>
  <div class="form-container">
    ...
    <slot></slot>
    <form>
      <div class="space" v-show="EmailInput">
        <input
          v-model="user.email"
          type="text"
          class="email-box"
      ...
      <div class="space !justify-start my-3 ml-1" v-if="isShowRemember">
        <input
          ...
          id="rememberMe"
        />
        <label for="rememberMe" class="text-base opacity-70 ml-3"
          >Rememer password</label
        >
      </div>
      <div class="space">
        <button type="button" class="login-button h-12 flex justify-center items-center" @click="login">
...
<script setup>
import { ref, computed, reactive, defineProps, watch, toRef } from "vue";
import { useStore } from "vuex";
import { useRouter } from "vue-router";
import loading_spinner from "../loading/loading_spinner.vue";
const props = defineProps(["isShowRemember", "EmailInput", "isShowSignup"]);
// declare tools
